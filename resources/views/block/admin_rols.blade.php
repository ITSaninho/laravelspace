            ...
            <table>
                ...
                @foreach ($contents as $content)
                    <tr class="table_info">
                        ...
                        <td class="can"><a href="{{ route('admin_rols_show_id',['content' => $content->id])}}"><span class="halflings eye-open"></span></a></td>
                        <td class="can"><a href="{{ route('admin_rols_edit',['id' => $content->id])}}"><span class="halflings pencil"></span></a></td>
                        <td class="can"><a href="{{ route('admin_rols_delete',['id' => $content->id])}}"><span class="halflings remove"></span></a></td>
