        ...
        <div class="col-sm-9">
            ...
            @if (session('status'))
                ...
                @endif
                        ...
                        <!-- start: Post -->
                <a href="{{ route('admin_photo_create')}}">Додати</a>
            <!-- start: Post -->
            ...
            <table>
                ...
                @foreach ($contents as $content)
                    <tr class="table_info">
                        <td>{{ $content->id }}</td>
                        <td>{{ $content->title }}</td>
                        <td><img src="/data/photo/{{$content->img}}" style="width:120px; height:120px;"></td>
                        <td>{{ $content->created_at }}</td>
                        <td>{{ $content->keywords }}</td>
                        <td>{{ $content->description }}</td>
                        <td class="can"><a href="{{ route('admin_photo_show_id',['content' => $content->id])}}"><span class="halflings eye-open"></span></a></td>
                        <td class="can"><a href="{{ route('admin_photo_edit',['id' => $content->id])}}"><span class="halflings pencil"></span></a></td>
                        <td class="can"><a href="{{ route('admin_photo_delete',['id' => $content->id])}}"><span class="halflings remove"></span></a></td>
