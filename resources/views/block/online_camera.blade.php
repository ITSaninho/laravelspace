    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            @foreach ($posts as $post)
                <div class="post">
                    <div class="post-img picture"><a href="post.blade.php"><img src="/data/post/images/{{$post->img}}" alt="{{$post->name}}" /><div class="image-overlay-link"></div></a></div>
                    <span class="post-icon standard"><i class="fa fa-pencil"></i></span>
                    <div class="post-content">
                        <div class="post-title"><h2><a href="{{ route('camera',['camera' => $post->id])}}">{{ $post->name }}</a></h2></div>
                        <div class="post-description">
                            <p>
                                {{ $post->description }}
                            </p>
                        </div>
                        <a class="post-entry" href="{{ route('camera',['camera' => $post->id])}}">Read More...</a>
