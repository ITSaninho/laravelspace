            ...
            @foreach ($contents as $content)
                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST">
                    ...
                    <div class="field">
                        ...
                        <div>
                            <input id="title" type="text" class="form-control" name="title" value="{{$content->title}}" required autofocus>
                    ...
                    <div class="field">
                        ...
                        <div>
                            <img src="/data/photo/{{$content->img}}" style="width:120px; height:auto;">
