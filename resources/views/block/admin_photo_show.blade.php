            ...
            <!-- start: Post -->
                @foreach ($contents as $content)
                    <div class="table_info">
                        <p style="float: right;">
                            <a href="{{ route('admin_photo_edit',['id' => $content->id])}}"><span class="halflings pencil"></span></a>
                            <a href="{{ route('admin_photo_delete',['id' => $content->id])}}"><span class="halflings remove"></span></a>
                        </p>
                        ...
                        <p><strong>Ключові слова:</strong> {{ $content->description }}</p>
                        <p id="avatar_td"><img src="/data/photo/{{$content->img}}" style="width:120px; height:auto;">
                    </div>
                    @endforeach
