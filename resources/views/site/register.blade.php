		...
		<div class="container">
	    	...
	    	<div class="collapse navbar-collapse" id="main-navigation">
	      		<ul class="nav navbar-right navbar-nav">
					<li class="dropdown">
            			<a href="register.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Home<b class="caret"></b></a>
					...
					<li class="active dropdown">
            			<a href="register.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Features<b class="caret"></b></a>
            			<ul class="dropdown-menu">
					...
					<li class="dropdown">
            			<a href="register.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Portfolio<b class="caret"></b></a>
            			<ul class="dropdown-menu">
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2 style="text-align:center; width: 100%; padding: 10px 0px 5px 0px">Create your account</h2>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<div id="footer-menu-logo">
						<a class="brand" href="register.blade.php#">Sma<span>rt</span>.</a>
					</div>
				</div>
