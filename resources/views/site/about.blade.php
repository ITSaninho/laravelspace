		...
		<div class="container">
	    	...
	    	<div class="collapse navbar-collapse" id="main-navigation">
	      		<ul class="nav navbar-right navbar-nav">
					<li class="dropdown">
            			<a href="about.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Home<b class="caret"></b></a>
					...
					<li class="dropdown">
            			<a href="about.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Features<b class="caret"></b></a>
            			<ul class="dropdown-menu">
					...
					<li class="dropdown">
            			<a href="about.blade.php#" class="dropdown-toggle" data-toggle="dropdown">Portfolio<b class="caret"></b></a>
            			<ul class="dropdown-menu">
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="fa fa-building-o"></i> About Us</h2>
    	...
    	<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="row">
					...
					<div id="team">
						...
						<!-- start: About Member -->
						<div class="col-sm-4">
							<img src="assets/img/team_member.jpg" alt="team member">
							...
							<div class="social_profiles">
								<ul class="social-bookmarks">
									...
									<li class="googleplus"><a href="about.blade.php#">googleplus</a></li>
									<li class="linkedin"><a href="about.blade.php#">linkedin</a></li>
									<li class="twitter"><a href="about.blade.php#">twitter</a></li>
									<li class="pinterest"><a href="about.blade.php#">pinterest</a></li>
								</ul>
							</div>	
						</div>
						<!-- end: About Member -->
			...
			<div class="col-sm-4">
				...
				<div id="sidebar">
					...
					<ul class="tabs-nav">
						<li class="active"><a href="about.blade.php#tab1"><i class="mini-ico-glass"></i> Tab 1</a></li>
						<li><a href="about.blade.php#tab2"><i class="mini-ico-list"></i> Tab 2</a></li>
						<li><a href="about.blade.php#tab3"><i class="mini-ico-pencil"></i> Tab 3</a></li>
					</ul>
	...
	<div class="container">	
		...
		<div class="clients-carousel">
			...
			<ul class="slides clients">
				<li><img src="assets/img/logos/1.png" alt=""/></li>
				<li><img src="assets/img/logos/2.png" alt=""/></li>	
				<li><img src="assets/img/logos/3.png" alt=""/></li>
				<li><img src="assets/img/logos/4.png" alt=""/></li>
				<li><img src="assets/img/logos/5.png" alt=""/></li>
				<li><img src="assets/img/logos/6.png" alt=""/></li>
				<li><img src="assets/img/logos/7.png" alt=""/></li>
				<li><img src="assets/img/logos/8.png" alt=""/></li>
				<li><img src="assets/img/logos/9.png" alt=""/></li>
				<li><img src="assets/img/logos/10.png" alt=""/></li>		
			</ul>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<div id="footer-menu-logo">
						<a class="brand" href="about.blade.php#">Sma<span>rt</span>.</a>
					</div>
				</div>
